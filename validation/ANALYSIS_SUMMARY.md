...
| Analysis | Main result | Read next |
|---|---|---|
| LOT r' per-star SNR | 261 stars below 60 ke- give median observed/predicted SNR **1.011**, bootstrap 95% CI 0.980–1.050; no resolved flux, colour, or detector-radius trend | [`ENDTOEND_RESIDUALS.md`](ENDTOEND_RESIDUALS.md) |
